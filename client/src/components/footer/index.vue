...
<template>
    <div class="footer">
        <div class="notice" v-show="ida" @click="clickHandler" :title="msg">
            <i class="iconfont icon-xiaoxitixing notice-icon"></i>
        </div>
        <transition name="fade">
            <div class="back-top" v-show="isShowBackTop" @click="backTopHandler" title="返回顶部">
                <!--<i class="iconfont icon-fanhuidingbu back-top-icon"></i>-->
    ...
    export default {
        ...
        methods: {
            ...
            scrollHandler() {
                ...
                this.isShowBackTop = top >= 100;
            }
        },
        created() {
            const _ida = localStorage.getItem('_ida');
            _ida && (this.ida = _ida) && (this.msg = '有一条留言被回复了哦,点击去查看')
        },
        mounted() {
